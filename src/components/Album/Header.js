	...
	render() {
		...
		return (
            <>
                <View style={{flex: 1, flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.5)', position: 'absolute',
                    ...
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                        ...
                        <View style={{flexDirection: 'row', marginLeft: 10, alignItems: 'center'}}>
                            {this.props.album?.images[0] ? (
                                <Image
                                    source={{uri: this.props.album?.images[0]?.url}}
                                    style={{height: 40, width: 40, borderRadius: 10}}
                                />
                            ) : null}
                            <Text style={{color: 'white', marginLeft: 10}}>{this.props.album?.name}</Text>
                        </View>
                    </View>
                </View>
                <Animated.Image
                ...
                >
                    <LinearGradient
                        colors={['rgba(142,68,173,1)','rgba(142,68,173,0.8)', 'rgba(52, 73, 94,1.0)', 'rgba(52, 73, 94,1.0)']}
