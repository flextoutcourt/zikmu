            ...
            <View style={{width: Dimensions.get('screen').width / 2 - 15, borderRadius: 10, ...this._margin()}}>
                ...
                >
                    <View style={{
                        ...
                        <Image source={{uri: this.props.follow?.images[0]?.url}}
                               style={{borderRadius: Dimensions.get('screen').width / 2 - 15, ...StyleSheet.absoluteFill}}/>
                    </View>
                    <View style={{marginLeft: 5}}>
                        ...
                        <Text
                            style={{fontSize: 18, color: 'white', fontWeight: 'bold'}}>{this.props.follow?.name}</Text>
                    </View>
                </TouchableOpacity>
            </View>
        );
