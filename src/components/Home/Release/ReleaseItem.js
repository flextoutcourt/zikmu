            ...
            <View style={{padding: 10}}>
                <TouchableOpacity onPress={() => this.props.navigation.push('Artist', {
                    ...
                    <View style={{width: 50, height: 50}}>
                        <Image source={{uri: this.state.artist?.images[0]?.url}}
                               style={{...StyleSheet.absoluteFill, borderRadius: 50}}/>
                    </View>
                    <View style={{marginLeft: 10}}>
                        <Text style={{color: 'white'}}>Dernière sortie de :</Text>
                        <Text
                            style={{fontWeight: 'bold', color: 'white', fontSize: 20}}>{this.state.artist?.name}</Text>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => this.props.navigation.push('Album', {
                    ...
                    <View style={{height: 150, width: 150}}>
                        <Image source={{uri: this.props.release?.images[0].url}} style={{
                        ...
                        <View>
                            ...
                            <View style={{flexDirection: 'row', flex: 1, alignItems: 'center'}}>
                                ...
                                <Text style={{
                                    color: 'white',
                                    fontWeight: '800',
                                }}>{this.props?.release?.artists[0]?.name}</Text>
                            </View>
                        </View>
