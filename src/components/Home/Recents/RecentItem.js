        ...
        return (
            this.props.isTop
                        ...
                        >
                            <View>
                                <View style={{
                                    ...
                                    <Image source={{uri: this.props.recent?.track?.album?.images[0]?.url}}
                                           style={{borderTopLeftRadius: 10, ...StyleSheet.absoluteFill}}/>
                                </View>
                            </View>
                            <View style={{marginLeft: 5}}>
                                <Text numberOfLines={1} style={{
                                    ...
                                    color: 'white',
                                }}>{this.props.recent?.track?.album?.name}</Text>
                                <Text style={{
                                    color: 'white',
                                    fontWeight: 'bold',
                                    opacity: .7,
                                }}>{this.props.recent?.track?.artists[0]?.name}</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <TouchableOpacity onPress={() => this._play(this.props.recent?.track?.uri)} style={{
                        flexDirection: 'row',
                        alignItems: 'center',
                        ...
                        <View style={{
                            ...
                            <Text numberOfLines={1}
                                  style={{maxWidth: '90%', color: 'white'}}>{this.props.recent?.track?.name}</Text>
                        </View>
                    </TouchableOpacity>
                </View>
                :
                <View style={{
                        ...
                        <View style={{}}>
                            ...
                            <View style={{padding: 5}}>
                                <Text numberOfLines={1} style={{
                                    maxWidth: (Dimensions.get('screen').width / 2) - 73,
                                    color: 'white',
                                }}>{this.props.recent?.track?.name}</Text>
                                <Text style={{
                                    color: '#7856FF',
                                    fontWeight: 'bold',
                                }}>{this.props.recent?.track?.artists[0]?.name}</Text>
                    ...
                    {/*	<View style={{marginLeft: 0, backgroundColor: '#1E2732', padding: 5, borderBottomRightRadius: 10, borderBottomLeftRadius: 10, flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start'}}>*/}
                    {/*		<FontAwesome5Icon name={'play-circle'} size={12} color='white' style={{marginRight: 10}}/>*/}
