                    ...
                    :
                        <View style={{margin: 10}}>
                            ...
                            <View style={{flexDirection: 'row', marginTop: 5, width: '100%'}}>
                                <Text numberOfLines={1}>{Math. floor((this.state.listening?.progress_ms/1000/60) << 0)}:{Math.floor((this.state.listening?.progress_ms/1000) % 60).toString().padStart(2, '0')}</Text>
