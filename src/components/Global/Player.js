    ...
    return this.state.listening ? (
      <TouchableOpacity
        style={{
          ...
          backgroundColor: this.state.big ? '#030303' : '#030303',
          zIndex: 99,
          padding: 0,
            ...
            <ScrollView style={{padding: 10}}>
              <View style={{flex: 2.5}}>
                ...
                <Text
                  ...
                  {this.state.listening?.item?.album?.name}
                </Text>
                <Image
                  source={{
              ...
              <View style={{flex: 1, justifyContent: 'flex-start'}}>
                <View
                  ...
                  <SeekBar
                    trackLength={
                      this.state.listening?.item?.duration_ms / 1000 ?? 0
                    }
          ...
          <View style={{margin: 10}}>
            ...
            <View style={{flexDirection: 'row', marginTop: 5, width: '100%'}}>
              <Text numberOfLines={1}>
                {Math.floor(
                  (this.state.listening?.progress_ms / 1000 / 60) << 0,
                )}
                :
              ...
              <Text>
                ...
                :
                {Math.floor(
                  (this.state.listening?.item?.duration_ms / 1000) % 60,
                )
                  .toString()
                  .padStart(2, '0')}
              </Text>
