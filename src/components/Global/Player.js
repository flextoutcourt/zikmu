...
import { Dimensions, FlatList, Image, ScrollView, StatusBar, Text, TouchableHighlight, TouchableOpacity, View } from 'react-native';
                    ...
                    :
                        <View style={{margin: 10}}>
                            <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                <View style={{flexDirection: 'row', alignItems: 'center', flex: 3, overflow: 'hidden'}}>
                                    ...
                                    <View style={{marginLeft: 5}}>
                                        <Text style={{color: 'white'}}>{this.state.listening?.item?.name}</Text>
                                        <Text style={{color: 'lightgrey'}}>{this.state.listening?.item?.artists[0]?.name}</Text>
                                    </View>
                                </View>
                            ...
                            <View style={{flexDirection: 'row', marginTop: 5, width: '100%'}}>
                                <Text>{Math. floor((this.state.listening?.progress_ms/1000/60) << 0)}:{Math.floor((this.state.listening?.progress_ms/1000) % 60).toString().padStart(2, '0')}</Text>
                                <View style={{height: 2, backgroundColor: 'tomato', flex: 1, alignSelf: 'center', marginLeft: 5, marginRight: 5}}>
                                    <View style={{height: 2, backgroundColor: 'grey', width: (this.state.listening?.progress_ms) / (this.state.listening?.item?.duration_ms) * 100 + "%"}}></View>
                                </View>
