            ...
            this.props.store.listening.listening
                ...
                <Animated.View style={{
                                                    ...
                                                    <View style={{flexDirection: 'row'}}>
                                                               ...
                                                               iconSize={this.state.big ? 24 : 24}/>
                                                        {
                                                            this.props.store.listening.listening?.actions?.disallows?.toggling_repeat_context && this.props.store.listening.listening?.actions?.disallows?.toggling_repeat_track && this.props.store.listening.listening?.actions?.disallows?.toggling_shuffle
                                                                ?
                                                                <TouchableOpacity onPress={() => alert('not liked')}
                                                                                  style={{marginLeft: 10}}>
                                            ...
                                            <View style={{
                                                ...
                                                <View style={{
                                                    ...
                                                    <TouchableOpacity onPress={() => this._shuffle()}
                                                                      disabled={this.props.store.listening.listening.actions.disallows.toggling_shuffle}>
                                                        <Icon name="shuffle" size={24}
                                                              style={{
                                                                  color: this.props.store.listening.listening?.shuffle_state ? 'green' : 'white',
                                                                  opacity: this.props.store.listening.listening.actions.disallows.toggling_shuffle ? 0.2 : 1,
                                                              }}/>
                                                    </TouchableOpacity>
                                                    ...
                                                    <TouchableOpacity onPress={() => this._repeat()}
                                                                      disabled={this.props.store.listening.listening.actions.disallows.toggling_repeat_track || this.props.store.listening.listening.actions.disallows.toggling_repeat_context}>
                                                        <Icon name="repeat" size={24}
                                                              style={{
                                                                  color: this.props.store.listening.listening?.repeat_state == 'context' ? 'green' : this.props.store.listening.listening?.repeat_state == 'track' ? '#B00D70' : 'white',
                                                                  opacity: this.props.store.listening.listening.actions.disallows.toggling_repeat_track || this.props.store.listening.listening.actions.disallows.toggling_repeat_context ? 0.2 : 1,
                                                              }}/>
                                                    </TouchableOpacity>
                                                </View>
                                                <View style={{
                            ...
                            <View style={{flexDirection: 'row', justifyContent: 'flex-start'}}>
                                ...
                                <View style={{marginLeft: 20}}>
                                    <Text style={{color: 'white', fontSize: 22, fontWeight: 'bold'}}>Écoute en cours sur
                                        :</Text>
                                    <Text
                                        style={{color: 'white', fontSize: 18}}>{this.state.devices?.active?.name}</Text>
                                </View>
                            </View>
                            <Text style={{fontSize: 16, color: 'white', marginVertical: 10}}>Séléctionnez un
                                appareil</Text>
                            <FlatList
                    ...
                    <Animated.View style={{
                        ...
                        <LinearGradient colors={['#7856FF', '#1E2732']}
                            ...
                            </View>
                            {
                                this.state.waiting_list.big
                                    ...
                                    <View style={{elevation: 10, shadowColor: '#000'}}>
                                        <Text style={{marginLeft: 10, fontSize: 16, color: 'white'}}>En cours de lecture
                                            :</Text>
                                        <TrackItem track={this.props.store.listening.listening?.item}
                                                   album={this.props.store.listening.listening?.item?.album}/>
                                        {this.props.store.listening.listening?.context ? <Text
                                            style={{marginLeft: 10, marginBottom: 10, fontSize: 16, color: 'white'}}>Prochains
                                            titres {this.state.context?.type == 'album' ? 'de ' + this.props.store.listening.listening?.item?.album?.name : null} : </Text> : null}
                                    </View>
                                    :
                                    null
                            }
                    ...
                    <Animated.View style={{
                        ...
                        <LinearGradient colors={['#7856FF', '#1E2732']}
                                        style={{flex: 1, borderRadius: 10, paddingTop: StatusBar.currentHeight}}>
                            <View style={{
                                width: Dimensions.get('screen').width,
                                height: 50,
                                alignItems: 'center',
                            ...
                            <View style={{flex: 1, padding: 30}}>
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{
                                            ...
                                            <View style={{
                                                ...
                                                <Image
                                                    source={{uri: this.props.store.listening.listening?.item?.album?.images[1]?.url}}
                                        ...
                                        <View style={{
                                            ...
                                            <Text style={{
                                                ...
                                                fontSize: 14,
                                                textAlign: 'center',
                                            }}>{this.props.store.listening.listening?.item?.name}</Text>
                                            <FlatList
                                                data={this.props.store.listening.listening?.item?.artists}
                                                renderItem={({item, key}) => (
                                                    <TouchableOpacity onPress={() => {
                                ...
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity onPress={() => alert('pressed')} style={{
                                            elevation: 10,
                                            backgroundColor: '#1E2732',
                                            borderRadius: 48,
                                            width: 48,
                                            ...
                                            <Image
                                                source={{uri: 'http://zikmu.api.flexcorp-dev.fr/tmp/icons/facebook.png'}}
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity onPress={() => alert('pressed')} style={{
                                            ...
                                            <Image
                                                source={{uri: 'http://zikmu.api.flexcorp-dev.fr/tmp/icons/whatsapp.png'}}
                                                style={{...StyleSheet.absoluteFill, borderRadius: 48}}/>
                                        </TouchableOpacity>
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity onPress={() => alert('pressed')} style={{
                                            ...
                                            <Image
                                                source={{uri: 'http://zikmu.api.flexcorp-dev.fr/tmp/icons/instagram.png'}}
                                                style={{...StyleSheet.absoluteFill, borderRadius: 48}}/>
                                        </TouchableOpacity>
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity onPress={() => alert('pressed')} style={{
                                            ...
                                            <Image
                                                source={{uri: 'http://zikmu.api.flexcorp-dev.fr/tmp/icons/messenger.png'}}
                                                style={{...StyleSheet.absoluteFill, borderRadius: 48}}/>
                                        </TouchableOpacity>
                                ...
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity onPress={() => Share.share({
                                            ...
                                            <Image
                                                source={{uri: 'http://zikmu.api.flexcorp-dev.fr/tmp/icons/twitter.png'}}
                                                style={{...StyleSheet.absoluteFill, borderRadius: 48}}/>
                                        </TouchableOpacity>
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity onPress={() => alert('pressed')} style={{
                                            ...
                                            <Image
                                                source={{uri: 'http://zikmu.api.flexcorp-dev.fr/tmp/icons/snapchat.png'}}
                                                style={{...StyleSheet.absoluteFill, borderRadius: 48}}/>
                                        </TouchableOpacity>
                    ...
                    <Animated.View style={{
                        ...
                        <LinearGradient colors={['#7856FF', '#1E2732']}
                            ...
                            <View>
                                ...
                                <View style={{
                                    ...
                                    <View style={{flex: 1, flexDirection: 'row', justifyContent: 'space-around'}}>
                                        <TouchableOpacity onPress={() => this._shuffle()} style={{
                                            flex: 1,
                                            alignItems: 'center',
                                            justifyContent: 'center',
                                        }}>
                            ...
                            <ScrollView scrollEnabled={true}
                                        style={{width: Dimensions.get('screen').width, paddingHorizontal: 10, flex: 1}}>
                                <View style={{
                                    alignItems: 'center',
                                    justifyContent: 'center',
                                    width: Dimensions.get('screen').width,
                                    ...
                                    <View
                                        style={{elevation: 10, backgroundColor: '#1E2732', borderRadius: 10, flex: 1}}>
                                        <View style={{
                                            height: Dimensions.get('screen').width / 2,
                                            width: Dimensions.get('screen').width / 2,
                                            elevation: 10,
                                ...
                                <TouchableOpacity onPress={() => alert('test')} style={{
                                    flexDirection: 'row',
                                    alignItems: 'center',
                                    justifyContent: 'flex-start',
                                    flex: 1,
                                ...
                                <TouchableOpacity onPress={() => alert('test')} style={{
                                    ...
                                    <Text style={{
                                        ...
                                        marginVertical: 20,
                                        marginLeft: 10,
                                    }}>Ajouter à la file d'attente</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => alert('test')} style={{
                                    flexDirection: 'row',
                                    alignItems: 'center',
