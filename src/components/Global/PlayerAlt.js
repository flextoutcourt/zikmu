...
import {Animated, Dimensions, Platform, StatusBar, Text, TouchableOpacity, UIManager, View,} from 'react-native';
													...
													<Animated.View style={{
														...
														<View style={{
															...
															<TouchableOpacity onPress={() => {
																...
																}}>{this.state.listening?.item?.artists[0]?.name}</Text>
															</TouchableOpacity>
														</View>
														{this.state.big ?
															<View><Liked track={this.state?.listening?.item}
															             iconSize={this.state.big ? 24 : 24}/></View> : null}
													</Animated.View>
													{
														!this.state.big
															?
											...
											</Animated.View>
											{
												this.state.big
													...
													<View style={{
														...
														<View style={{
															...
															<View style={{
																...
																<TouchableOpacity
																	onPress={() => alert('deploy_share_menu')}>
																...
																<TouchableOpacity
																	onPress={() => alert('deploy_waiting_list')}>
													...
													<Animated.View style={{
														...
														<Icon name="bluetooth" size={this.state.big ? 48 : 24}
