    ...
    <SafeAreaView
      ...
      <ImageBackground
        ...
        <LinearGradient colors={['rgba(120,86,255, 0.5)', 'rgba(0,0,0,0.5)']}>
          ...
          <View style={{flex: 1, alignItems: 'center', padding: 10}}>
            <Text style={{color: 'white'}}>
              Explorez tout un monde de musiques sans publicité, hors connexion
              et même avec l'écran verrouilé. Disponible sur mobile et
              ordinateur, Ziq&Mu propose des albums officiels, des playlists,
              des signles et plus encore.
            </Text>
          </View>
        </LinearGradient>
      </ImageBackground>
